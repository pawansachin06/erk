    ...
    methods: {
        uploadImage: function () {
            ...
            axios.post(thisObject.site_url + '/admin/account/upload-image', formData, {
                ...
                thisObject.account_data.image_url = response.data.data.url;
...
//                thisObject.errors = error.response.data.errors;
        ...
        submit() {
            ...
            thisObject.$validator.validate().then(valid => {
                if (valid) {
                    axios.post(thisObject.site_url + '/admin/account/store', thisObject.account_data).then(function (response) {
                        thisObject.$swal({
                            title: "Success",
                            text: 'Record added successfully!',
                            icon: 'success'
                        });
                        thisObject.account_data = {
                            image_url: ""
                        };
