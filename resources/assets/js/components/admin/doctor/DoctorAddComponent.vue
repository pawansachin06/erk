<template>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <vue-editor v-validate="'required'" v-model="doctor_data.description" name="description" placeholder="Enter description"> </vue-editor>
    ...
    methods: {
        ...
        uploadImage: function () {
            ...
            axios.post(thisObject.site_url + '/admin/doctor/upload-image', formData, {
                ...
                thisObject.doctor_data.image_url = response.data.data.url;
...
//                thisObject.errors = error.response.data.errors;
        ...
        submit() {
            ...
            thisObject.$validator.validate().then(valid => {
                if (valid) {
                    axios.post(thisObject.site_url + '/admin/doctor/store', thisObject.doctor_data).then(function (response) {
                        thisObject.$swal({
                            title: "Success",
                            text: 'Record added successfully!',
                            icon: 'success'
                        });
                        thisObject.doctor_data = {
                            name: "",
                            title: "",
                            description: "",
                            image_url: "",
