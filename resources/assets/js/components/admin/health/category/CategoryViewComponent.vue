    ...
    <div class="content-section">
        <div class="card">
            <div class="card-header border bottom card-header border bottom d-flex justify-content-between align-items-center">
                <h4 class="card-title">Other Category</h4>
                <div class="pull-right">
                    <a :href="site_url+'/admin/health/category-create'" class="btn btn-default m-0">添加新类别</a>                    
                </div>
            </div>
                        ...
                        <tbody>
                            <tr v-for="(c,i) in category">
                                ...
                                <td class="text-left font-size-18">
                                    <a :href="site_url+'/admin/health/category-edit/'+c.id" class="text-gray m-r-15"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script>
    ...
    export default {
        ...
        methods: {
            loadAllCategory() {
                var thisObject = this;
                axios.get(thisObject.site_url + '/admin/health/loadAllCategory')
            ...
            deleteCategory(id) {
                var thisObject = this;
                axios.get(thisObject.site_url + '/admin/health/category-delete/' + id)
                        .then(function (response) {
