    ...
    methods: {
        uploadImage: function () {
            ...
            axios.post(thisObject.site_url + '/admin/news/post/upload-image', formData, {
                ...
                thisObject.post_data.image = response.data.data.url;
...
//                thisObject.errors = error.response.data.errors;
        ...
        update() {
            ...
            thisObject.$validator.validate().then(valid => {
                if (valid) {
                    axios.post(thisObject.site_url + '/admin/news/post-update', thisObject.post_data).then(function (response) {
                        thisObject.$swal({
                            title: "Success",
    ...
    mounted() {
        ...
        this.blog_detail.image = this.post_data.image;
    }
}
</script>
