    ...
    <div class="content-section">
        <div class="card">
            <div class="card-header border bottom card-header border bottom d-flex justify-content-between align-items-center">
                <h4 class="card-title">News Post</h4>
                <div class="pull-right">
                    <a :href="site_url+'/admin/news/post-create'" class="btn btn-default">发布新帖</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody> 
                            <tr v-for="(p,i) in post">
                                ...
                                <td class="text-left font-size-18">
                                    <a :href="site_url+'/admin/news/post-edit/'+p.id" class="text-gray m-r-15"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script>
    ...
    export default {
        ...
        methods: {
            loadAllPost() {
                var thisObject = this;
                axios.get(thisObject.site_url + '/admin/news/post/loadAllPost')
            ...
            deletePost(id) {
                var thisObject = this;
                axios.get(thisObject.site_url + '/admin/news/post-delete/' + id)
                        .then(function (response) {
